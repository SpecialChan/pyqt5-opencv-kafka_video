...
class Ui_TabWidget(object):
    ...
    def retranslateUi(self, TabWidget):
        ...
        TabWidget.setWindowTitle(_translate("TabWidget", "佩奇-AI实时监测视频流系统"))
        self.pushButton.setText(_translate("TabWidget", "打开图片"))
        self.pushButton_2.setText(_translate("TabWidget", "打开视频"))
        TabWidget.setTabText(TabWidget.indexOf(self.tab), _translate("TabWidget", "控制台01"))
        TabWidget.setTabText(TabWidget.indexOf(self.tab1), _translate("TabWidget", "控制台02"))
        TabWidget.setTabText(TabWidget.indexOf(self.tab_2), _translate("TabWidget", "控制台03"))
